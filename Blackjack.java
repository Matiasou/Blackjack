...
public class Blackjack {
    ...
    public static void printResult(Player dealer, Player user) {
        ...
        else if(user.getNumCards() == 2 && user.getHandValue() == 21){
            System.out.println("Blackjack!");
        }
        else if(user.getHandValue() == dealer.getHandValue() && user.getHandValue() <21 && dealer.getHandValue() <21){
            System.out.println("Push!");
        }
        else if (dealer.getHandValue() > 21 && user.getHandValue() <21 ) {
